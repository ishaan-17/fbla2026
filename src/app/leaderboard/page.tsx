...
export default function LeaderboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      {/* Header */}
      <ScrollRevealStagger className="text-center mb-10" staggerDelay={0.1}>
        <ScrollRevealItem>
      ...
      {session && (
        <ScrollReveal delay={0.15} direction="up" className="mb-8">
      ...
      {/* Stats Cards */}
      <ScrollRevealStagger className="grid grid-cols-3 gap-4 mb-10" staggerDelay={0.08}>
        <ScrollRevealItem>
