...
import { motion, useMotionValue, useAnimationFrame, useTransform, MotionStyle } from 'motion/react';
...
export default function GradientText({
  ...
  return (
    <motion.span
      className={`inline gradient-text-wrapper ${className}`}
      style={motionStyle}
